		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="">
		    	...
		    	<option value="Primero">Musica</option>
		    	<option value="Segundo">Pintura</option>
		    	<option value="Tercero">Danza</option>
		    	<option value="Cuarto">Fotografia</option>
		    	<option value="Quinto">Teatro</option>
		    </select>
	  	</div>
	  	<div class="form-group">
